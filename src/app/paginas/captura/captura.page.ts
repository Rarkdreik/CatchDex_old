...
import { LvupService } from 'src/app/servicios/lvup.service';
...
export class CapturaPage implements OnInit {
  ...
  public pokeSalvaje: PokemonInterface; public pokemonBatalla: PokemonInterface;
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(async () => {
              ...
              this.anadirPokemon();
              this.route.dispose();
              await this.route.navigateByUrl('/tabs/tab2');
            }, 1000);
          }, 4000);
        }, 3000);
